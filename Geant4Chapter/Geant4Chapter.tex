...
These results were calculated using LISE++.

This calculation is shown in figure \ref{fig:lisealcalc}.

This is compared to the data in figure \ref{fig:aldegrader}.
