...
In addition, with this geometry, all photon energies below 100 keV are absorbed.
...
The relative normalization $p0$ is unimportant in the analysis.
The slope $p1$ is consistent with zero to $10^{-7}$.
