...
They were run with the NSCL firmware.
...
Both of these had the beam on signal, beam off signal, a 100 Hz pulser, and the signal from the light pulser. 
The third module only recorded the digitized wave-forms from the PVT detector.
A list of the three modules and which channel had which detector is seen in table \ref{tab:cablingscheme}.
%
\begin{table}[!hbt]
	\centering
