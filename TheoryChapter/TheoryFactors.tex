...
This is the last of the relavent. electromagnetic corrections
...
The four factors are $c_{1nuc}$, which is the Gamow-Teller matrix element, $c_{2nuc}$, which parameterizes the dependence of the Gamow-Teller form factor on the momentum transfwer, $b_{wm}$, which is the weak magnetism, and $d$, which is the induced tensor term.
The nuclear shape factor is then written as shown in equation \ref{eq:shapefactor}
