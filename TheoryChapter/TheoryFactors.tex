...
The radial part of the nucleon wavefunctions are modelled as a rectangle with width R.
...
where the $C$ coefficients are defined in equation \ref{eq:csconvocorrection} \cite{WIL90} 
...
This hypotheis states that the weak interaction possesses a universal strength and a universal $V-A$ form \cite{Man58}.
...
Equation \ref{eq:tensorformfactor} gives the the tensor form factor \cite{Cal77}
...
This matrix element is shown in equation \ref{eq:dmatrix}
\begin{equation}
...
\section{Summary}
With all these corrections, the experiment can be described to the required percision.
