...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.68\textwidth]{RadCorrections_20F.pdf}}
...
The alignment of out-going electrons was measured, which is a higher order polarization.
To describe the alignment, the nuclear form factors are needed.  
The measurement was done with both nuclei and added to eliminate some of the form factors such as the dependence of the alignment on $b_{WM}$. 
To eliminate the remaining form factors, the alignment measurement added to existing gamma-beta angular correlation data.
...
Ratios between the spectra were taken.
From these ratios, numerical derivatives were taken and weighted with the normalized phase space.
These results are shown in figure \ref{fig:theoryuncer}.
These results were futher verified by generating a spectrum with a $b_{WM}$ and a $b_{GT}$.
...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.78\textwidth]{DerivPlot.pdf}}
