...
\begin{figure}
    ...
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth]{CsILBCvGainSMOffsetis10p054histfit.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth]{CsILBCvGainBSMOffsetis10p054histfit.png}}
    \end{minipage}
...
\begin{figure}
	\centerline{\includegraphics[width=0.7\textwidth]{MCLBCvbwmOffsetis10Applied20_gain.png}}
...
\begin{figure}
    \centering
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth]{CsILBCvGainSMOffsetism6p64histfit.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth]{CsILBCvGainBSMOffsetism6p64histfit.png}}
    \end{minipage}
...
\begin{figure}
    \centering
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth]{CsIGSMvUBC4HistFit.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth]{CsIGBSMvUBC4HistFit.png}}
    \end{minipage}
