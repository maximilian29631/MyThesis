...
In terms of the quark level coupling constants, this can be rewritten, as shown in equation \ref{eq:bgtquarklevel} \cite{Gon19}
...
The energy of the output particles is comapred to that of the standard model background, and the difference recorded.
