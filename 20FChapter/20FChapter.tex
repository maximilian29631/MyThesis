...
\begin{figure}[!htb]
	...
	\caption{A sample beta energy spectrum using a plastic scintillator detector \cite{Min11}.
		 ...
		 This was measured at Tandem Accelerator Complex of the Unversity of Tsukuba.
		 } 
	\label{fig:keispec}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{On the left there are simulated spectra of beta spectrum measured with a germanium detector \cite{Het89}.
		 ...
		 The beta spectrum was measured at the Labratory of Physics at the University of Montreal. }
	\label{fig:hethspec}
\end{figure}
...
This experiment used many different sources to get the calibration and the response fuction.
