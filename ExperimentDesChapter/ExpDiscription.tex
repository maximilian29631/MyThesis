...
\begin{figure}
	...
	\centerline{\includegraphics[width=0.90\textwidth, height = 4 cm]{CsIDegraderExclusionRegion_Cropped.png}}
    \end{minipage}
...
\begin{figure}
	%\centerline{\includegraphics[width=0.68\textwidth]{fig_setup.pdf}}
		\centerline{\includegraphics[width=0.68\textwidth]{fig_PVTImplantSketch.png}}
...
However, many runs were cut short when the DAQ stopped recording data for one of the detectors.
