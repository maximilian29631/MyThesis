...
\begin{figure}[!htb]
	...
	\begin{minipage}{0.50\textwidth}
		\centerline{\includegraphics[width=0.9\textwidth]{fig_hethBetaSpec.png}}
	\end{minipage}\hfill
	\begin{minipage}{0.50\textwidth}
		\centerline{\includegraphics[width=0.9\textwidth]{fig_heth20f.png}}
	\end{minipage}
	\caption{On the left there are simulated spectra of beta spectrum measured with a scintillator \cite{Het89}.
		 ...
		 On the right is the measured and fitted $^{20}$F beta spectrum.}
	\label{fig:hethspec}
\end{figure}
