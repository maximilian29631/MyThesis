...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.5\textwidth]{20FDecayScheme_v4_WithNa.png}}
	\caption{The decay scheme of $^{20}$F shown in context of the isospin triplet.
		    The transition used the calculate $b_{WM}$ is shown with the blue arrow.}
	\label{fig:DecayScheme}
\end{figure}

The 1.6 MeV gamma ray in the transition, the red arrow in figure \ref{fig:DecayScheme}  allows for a coincidence measurement to take place.
...
With all these effects, the second-class current induced tensor form factor was measured as $0.18 \pm 0.48$, consistent with zero. 
