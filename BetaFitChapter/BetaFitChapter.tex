...
\begin{table}[!hbt]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{llll}
		Parameter Name & Parameter Value & Parameter Uncertainty & Systematic Uncertainty \\
		Electron end point energy & 5389.865 $keV$ & 0.081 $keV$ & \\
		Charge radius & 3.0055 $fm$ & 0.0021 $fm$ & \\
		Convolution & 1.112 & 0.008 & 0.004 	 
		\end{tabular}}
...
\begin{table}[!hbt]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{llll}
		Parameter Name & Parameter Value & Parameter Uncertainty  or Range & Systematic Uncertainty \\
 		Lower beta cut & 250 keV & 200 to 2000 keV & 0.0283 \\
		Binning of data histogram & 64 & & \\
		Binning of fitting histograms & 64 & &  		
		\end{tabular}}
...
\begin{table}[!hbt]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lllll}
		Parameter Name & Parameter Variable & Parameter Value & Parameter Uncertainty  or Range & Systematic Uncertainty \\
		Weak magentism & $b_{wm}$ & 43.4 & 1.2 \cite{Min11} & 0.0028 \\
		Induced tensor form factor & $d$ & 40.5 &  3.7 \cite{Min11} & 0.0004 \\
		Fermi matrix element & $c_{1nuc}$ & 0.253 & 0.004 \cite{Min11} & 0.0017 \\
		Second forbidden matrix element & $c_{2nuc}$  & 0.755 $fm^{2}$ & 0.257 $fm^{2}$ \cite{Elm87} & 0.0011
		\end{tabular}}
