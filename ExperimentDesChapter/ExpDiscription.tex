...
\begin{figure}
    ...
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
	\centerline{\includegraphics[width=0.90\textwidth, height = 4 cm]{CsIRawRatevDegraderThicknessOnePass.png}}
    \end{minipage}
...
\begin{figure}
	\centerline{\includegraphics[width=0.45\textwidth]{fig_PVTSetupPicture.png}}
...
\begin{figure}
	\centerline{\includegraphics[width=0.45\textwidth]{fig_CsISetupPicture.png}}
