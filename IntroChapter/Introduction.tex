...
\begin{document}
Particle physics is analyzed under the framework of the standard model.
This model has many parameters that could theorically be non-zero, but have been measured to be zero up to this point.
Testing the standard model is done in many ways.
...
This is done with large colliders. 
