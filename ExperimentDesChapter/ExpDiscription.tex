...
This was done after the main run, and the simulation in figure \ref{fig:lisealcalc} matched the measurement in figure \ref{fig:degraderdata}.
...
\begin{figure}
	\centerline{\includegraphics[width=0.68\textwidth]{PVTDetectorSketch.png}}
