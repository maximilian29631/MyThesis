...
However, to reach this uncertaintly, all that would be needed would be to run the the experiment again with higher statistics. 
Then, the statistical uncertainty would be neglible, and the systematic uncertainty would be the limiting factor. 
...
This can be seen in figure %insert figure here
...
In order to increase efficiency for the 1.6 MeV gamma ray, the implant detector could be more completely incased with gamma detectors.
