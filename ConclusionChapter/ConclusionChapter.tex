...
If <INSERT DETECTOR HERE> were used instead, where the non-linearities are much less \cite{Kno10}, more of the spectrum could be measured. 
There would be an increased sensitivity to the Fierz term due to the $1/W$ functional depedence of that term.
