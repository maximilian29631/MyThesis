...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.5\textwidth]{20FDecayScheme.png}}
...
It can be made in sufficient qualities to get a high statistics beta spectrum.
Because of these characteristics, this measurement was not the first to use $^{20}$F.
...
A shape measurement of $^{20}$F was made with a high purity germanium detector \cite{Het89}.
...
What happened is that electrons entered the detector, deposited some of their energy, and bounced back out.
...
Due to contamination, the effective shape measurement analysis was started at 1.5 MeV.
For this measurement there were several systematic effects.
The largest uncertainty was due to uncertainties in the response function.
...
The current work is also was a shape spectrum measurement, much like the two cited above.
The ultimate goal is however a  determination of the Fierz term. 
In order to get at the Fierz term, the beta energy spectrum must be described precisely.
