...
The peak of the beam spot was fitted with a 2-D Gaussian function
...
\begin{figure}
	...
	\centerline{\includegraphics[width=0.90\textwidth]{degrad.pdf}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
	\centerline{\includegraphics[width=0.70\textwidth]{CsIRawRatevDegraderThicknessOnePass.png}}
    \end{minipage}
...
\begin{figure}
	\centerline{\includegraphics[width=0.78\textwidth]{PVTDetectorSketch.png}}
...
\begin{figure}
	\centerline{\includegraphics[width=0.48\textwidth]{fig_CsISetupPicture.png}}
