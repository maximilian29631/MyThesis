...
\title{Precision Measurements in $^{20}$F Beta Decay} %% Put the title of your dissertation here.
...
The analysis is not yet completed since there is uncertainty on how to deal with the dependence of the result on the fitting range. 
The current uncertainty on the Fierz term is 0.0042$_{stat} \pm$ 0.0043$_{sys}$.
...
He taught me a lot about research in my first year of grad school.
The experiment would not have been possible without him.
Next, I'd like to thank Xueying Huyan.
She always answered any questions I had, especially those involving GEANT4.
I'd like to thank Shloka Chandavar and Tom-Erik Haugen for answering questions and giving me feedback.
...
\subfile{20FChapter/20FChapter.tex}
...
\chapter{Conclusion}
\subfile{ConclusionChapter/ConclusionChapter.tex}
\end{doublespace}
