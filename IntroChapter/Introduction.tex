...
\begin{equation}
	\frac{dN}{dE d\Sigma} = PS(E,\Sigma) \times C(E, \Sigma) \times W(E, \Sigma)  
	\label{eq:betaenspectrum}
\end{equation}
with $E$ being the energies of all the outgoing particles and $\Sigma$ the direction of all outgoing particles.
The phase space, $PS(E,\Sigma)$, and the corrections, $C(E,\Sigma)$, will be discusses further in the thesis. 
The contributions from the weak interaction, $W(E,\Sigma)$, are to first order \cite{Jack57} %shown in equation \ref{eq:matrixelement} \cite{Gon19}
\begin{equation}
	 W(E,\Sigma) = \xi [1 + a \frac{\vec{p_{e}} \cdot \vec{p_{\nu}}} {E_{e} E_{\nu}}  +  b \frac{m_{e}}{E_{e}} + \frac{\vec{<J>}}{J} \cdot (A \frac{ \vec{p_{e}} }{E_{e}} + B \frac{\vec{p_{\nu}}}{E_{\nu}} + D \frac{\vec{p_{e}} \times \vec{p_{\nu}}}{E_{e} E_{\nu}})]
