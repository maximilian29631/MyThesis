...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.65\textwidth]{CsIRun317FierzTermResids.png}}
...
\begin{figure}
    ...
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainSMOffsetis10p054histfit.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainBSMOffsetis10p054histfit.png}}
    \end{minipage}
...
In addtion, in both the data and the Monte Carlo, the trend is only seen in the $G_{SM}$ fits..

\begin{figure}
	\centering
	\begin{minipage}{0.50\textwidth}
		\centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{MCGsmvLBCFitOffsetis16RealOffsetis0.png}}
	\end{minipage}\hfill
	\begin{minipage}{0.50\textwidth}
		\centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{MCGbsmvLBCFitOffsetis16RealOffsetis0.png}}
	\end{minipage}
...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.70\textwidth]{fig_offsetvslopecurve_gain.pdf}}
...
\begin{figure}
    \centering
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainSMOffsetism6p64histfit.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainBSMOffsetism6p64histfit.png}}
    \end{minipage}
...
\subsection{The Relative Normalization of the Beta-gamma Sum Spectrum}

The realtive normalization of the beta-gamma sum spectrum can induce an effect in the fitted gain.
...
Therefor, this effect can be excluded. 
...
\begin{figure}
    \centering
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsIGSMvUBC4HistFit.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsIGBSMvUBC4HistFit.png}}
    \end{minipage}
...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.70\textwidth]{CsIbwmSysEffvLBC.png}}
