...
For this work, a neclear level treatment of beta decay is done.  
...
\begin{equation}
	\frac{dN}{dE d\Omega} = PS(E,\Omega) \times C(E, \Omega) \times W(E, \Omega)  
	\label{eq:betaenspectrum}
\end{equation}
with $E$ being the energies of all the outgoing particles and $\Omega$ the direction of all outgoing particles.
The phase space, $PS(E,\Omega)$, and the corrections, $C(E,\Omega)$, will be discusses further in the thesis. 
...
\end{equation}
where $M_{F}$ is the Fermi matrix element, $C_{V}$ and $C_{V}'$ are vector coupling constants, and $|\rho|$ is the ratio of the Gamow-Teller matrix element to the Fermi matrix element times $C_{A}/C_{V}$.
