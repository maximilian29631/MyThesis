...
\begin{equation}
	\frac{dN}{dE} = PS(E) * C(E) * (1 + b_{GT}\frac{m_{e}}{E})
...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.65\textwidth]{RadCorrections_20F.pdf}}
...
One data set was the alignment of out-going electrons, which is a higher order polarization.
...
The corrections and phase space were calcuated with the central value of both parameters.
