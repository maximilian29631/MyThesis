...
By comparing equation \ref{eq:hulthorg}, equation \ref{eq:screenbeta} and equation \ref{eq:hartorg}, the results are %in equation \ref{eq:betaanswer} are obtained.
...
where the $C$ coefficients are defined as \cite{WIL90} %in equation \ref{eq:csconvocorrection} \cite{WIL90} 
