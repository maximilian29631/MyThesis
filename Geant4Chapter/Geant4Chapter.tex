...
GEANT4 propogates the particles in steps.
...
The energy deposited from the intitial gamma ray was one category.
...
To split the energies from different detectors, the initial energy of each primary particle was checked.
Since the gamma rays are mono-chromatic, the energy of the primary particle was compared to 1.6336 MeV.
It was also checked if the primary particle had a charge or not.
This took care of most cases, unless a sampled inner bremsstrahlung photon had exactly that energy, which was rare enough to be negligable.
