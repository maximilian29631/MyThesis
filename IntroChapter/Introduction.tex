...
The contributions from the weak interaction, $W(E)$ are to first order \cite{Jac57} %shown in equation \ref{eq:matrixelement} \cite{Gon19}
...
\end{equation}
where $\alpha$ is the fine structure constant \cite{Jac57}.
