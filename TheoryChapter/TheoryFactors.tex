...
The form factors are described in table \ref{tab:formfact}
...
How the shape factor depends on the form factors is shown in equation \ref{eq:sfcs} 
...
Different values of $d$, or instance, range from 20.5 to 40.5.  %need citations here.
The calculation of $c_{1nuc}$ depends on the $ft$ value. 
The calculation is shown in equation \ref{eq:c1eq}

The weak magnetism ,$b_{wm}$, is of special theoretical interest. 

\subsection{The Weak Magnetism}

The weak magnetism form factor is one of the two form factors determined 
%\end{document}
