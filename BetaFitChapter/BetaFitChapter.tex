...
\begin{figure}
    ...
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainSMOffsetis10p054histfit_SameScale.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainBSMOffsetis10p054histfit_SameScale.png}}
    \end{minipage}
...
\begin{figure}
	\centering
	\begin{minipage}{0.50\textwidth}
		\centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{MCGsmvLBCFitOffsetis16RealOffsetis0_SameScale.png}}
	\end{minipage}\hfill
	\begin{minipage}{0.50\textwidth}
		\centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{MCGbsmvLBCFitOffsetis16RealOffsetis0_SameScale.png}}
	\end{minipage}
...
\begin{figure}
    \centering
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainSMOffsetism6p64histfit_SameScale.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsILBCvGainBSMOffsetism6p64histfit_SameScale.png}}
    \end{minipage}
...
\begin{figure}
    \centering
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsIbwmvLBCoffsetm6p6.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.50\textwidth}
        \centerline{\includegraphics[width=0.9\textwidth,height = 5 cm]{CsIbgtvLBCoffsetm6p6.png}}
    \end{minipage}
