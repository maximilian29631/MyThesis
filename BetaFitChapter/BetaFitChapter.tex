...
\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.80\textwidth]{CsIGammaFitsRun317.png}}
	\caption{A sample fitting of the gamma detectors over the compton scattering range.} 
	\label{fig:GammaFit}
\end{figure}

\begin{figure}[!htb]
	\centerline{\includegraphics[width=0.80\textwidth]{CsIGammaRatiosRun317.png}}
...
\begin{table}[!hbt]
	...
	\caption{Systematic uncertainties due to simulation inputs.}
		...
		Charge radius & 3.0055 fm & 0.0021 fm  & 0.2 & 0.0003 \\ \hline \hline
		\end{tabularx}
