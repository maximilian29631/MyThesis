...
The details of the fit of the beta decay spectrum shape is in the next chapter. 
...
The results of the ratios can be seen in figure \ref{fig:histogramtotreeratio}.
...
\begin{figure}
    ...
    \end{minipage}
    \caption{Ratio of proccessing data two different ways.
