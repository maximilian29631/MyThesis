...
For example, fitting the histogram generated with an offset of 0, and fit with an offset of 16.65 gives an effect as seen in figure \ref{fig:MCoffset10applied20}.
...
GEANT4 overestimates the main peak relative to the region below the main peak.
...
The ratio is within 20\% over the center for all four detectors.
